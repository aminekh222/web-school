...
class AttestationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.attestations.create', compact('students'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.attestations.show', $attestation)
    ...
    public function generatePDF(Attestation $attestation)
    {
        ...
        return $pdf->stream('attestation-' . $attestation->numero_attestation . '.pdf');
    }

    /**
     * Download PDF for the specified attestation.
     */
    ...
    {
        $students = User::where('role', 'student')->get();
        return view('admin.attestations.mass-generate', compact('students'));
    }
